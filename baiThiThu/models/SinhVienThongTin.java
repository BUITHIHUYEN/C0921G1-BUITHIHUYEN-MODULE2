...
public class SinhVienThongTin  extends SinhVien{
    private double tienHocPhi;
    private String ngayRaTruong;

    public SinhVienThongTin() {
    }
    public SinhVienThongTin(String maSinhVien, String tenSinhVien, String ngayNhapHoc, double tienHocPhi, String ngayRaTruong) {
    ...
    public String toString() {
        return getMaSinhVien()+","+getTenSinhVien()+","+getNgayNhapHoc()+","+tienHocPhi+","+ngayRaTruong;
    }
}
